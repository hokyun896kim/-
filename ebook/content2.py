...
# 책별 메타데이터(검색 키워드/주제) — 2권은 ‘종목추천’이 아니라 ‘경제뉴스 읽기’
DESCRIPTION="금리·환율·실적 뉴스를 내 돈의 언어로 번역하는 AI 경제 읽기"
KEYWORDS=["AI 경제","경제 뉴스","경제 공부","금리","환율","물가","실적 읽기","챗GPT 경제","직장인 재테크"]
READKEY="이 책의 핵심은 정답이 아니라 ‘질문의 구조’입니다."
READGUIDE="이 책은 순서대로 읽어도 좋지만, 5부와 부록은 필요할 때 다시 꺼내보는 실전 노트처럼 활용하셔도 좋습니다."
# 부(部) 표지에 들어갈 ‘한 줄 요약’ — 그 부 전체를 한 문장으로
PART_SUM={
 1:"경제뉴스는 단어가 아니라 ‘연결고리’로 읽고, AI에게는 결론이 아니라 ‘판단 구조’를 시킨다.",
 2:"금리·환율·물가·고용은 멀리 있는 뉴스가 아니라, 결국 ‘내 지갑’으로 흘러든다.",
 3:"기업의 숫자를 ‘생존 일기’로 읽으면, 매출 너머의 좋은 회사가 보인다.",
 4:"원문·인과·침묵·편향을 점검하면, 흩어진 정보가 비로소 ‘판단’이 된다.",
 5:"하루 10분이 쌓이면 점이 선이 되고, 경제가 마침내 ‘내 것’이 된다.",
}
CH2_FIGURE={
